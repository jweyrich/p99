...
#define O_RWL_ORWL_ALIAS(NAME) P99_PASTE3(o_rwl_, NAME, _alias)
#define ORWL_ALIAS(NAME) O_RWL_ORWL_ALIAS(NAME)

#define O_RWL_ORWL_REGISTER(NAME) P99_PASTE3(o_rwl_, NAME, _regptr)
#define ORWL_REGISTER(NAME) O_RWL_ORWL_REGISTER(NAME)

#define O_RWL_ORWL_FTAB(NAME) P99_PASTE3(o_rwl_, NAME, _ftab)
#define ORWL_FTAB(NAME) O_RWL_ORWL_FTAB(NAME)

#define ORWL_DOMAIN_TABLE(NAME) P99_PASTE2(o_rwl_domain_tab_, NAME)
