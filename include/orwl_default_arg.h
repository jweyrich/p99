...
#define __DOIT2(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT2(N, OP, FUNC, A, ...) __DOIT2(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT3(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT3(N, OP, FUNC, A, ...) __DOIT3(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT4(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT4(N, OP, FUNC, A, ...) __DOIT4(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT5(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT5(N, OP, FUNC, A, ...) __DOIT5(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT6(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT6(N, OP, FUNC, A, ...) __DOIT6(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT7(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT7(N, OP, FUNC, A, ...) __DOIT7(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT8(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT8(N, OP, FUNC, A, ...) __DOIT8(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT9(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT9(N, OP, FUNC, A, ...) __DOIT9(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT10(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT10(N, OP, FUNC, A, ...) __DOIT10(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT11(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT11(N, OP, FUNC, A, ...) __DOIT11(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT12(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT12(N, OP, FUNC, A, ...) __DOIT12(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT13(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT13(N, OP, FUNC, A, ...) __DOIT13(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT14(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT14(N, OP, FUNC, A, ...) __DOIT14(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT15(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT15(N, OP, FUNC, A, ...) __DOIT15(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT16(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT16(N, OP, FUNC, A, ...) __DOIT16(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT17(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT17(N, OP, FUNC, A, ...) __DOIT17(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT18(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT18(N, OP, FUNC, A, ...) __DOIT18(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT19(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT19(N, OP, FUNC, A, ...) __DOIT19(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT20(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT20(N, OP, FUNC, A, ...) __DOIT20(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT21(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT21(N, OP, FUNC, A, ...) __DOIT21(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT22(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT22(N, OP, FUNC, A, ...) __DOIT22(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT23(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT23(N, OP, FUNC, A, ...) __DOIT23(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT24(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT24(N, OP, FUNC, A, ...) __DOIT24(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT25(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT25(N, OP, FUNC, A, ...) __DOIT25(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT26(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT26(N, OP, FUNC, A, ...) __DOIT26(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT27(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT27(N, OP, FUNC, A, ...) __DOIT27(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT28(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT28(N, OP, FUNC, A, ...) __DOIT28(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT29(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT29(N, OP, FUNC, A, ...) __DOIT29(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT30(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT30(N, OP, FUNC, A, ...) __DOIT30(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT31(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT31(N, OP, FUNC, A, ...) __DOIT31(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT32(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT32(N, OP, FUNC, A, ...) __DOIT32(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT33(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT33(N, OP, FUNC, A, ...) __DOIT33(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT34(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT34(N, OP, FUNC, A, ...) __DOIT34(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT35(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT35(N, OP, FUNC, A, ...) __DOIT35(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT36(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT36(N, OP, FUNC, A, ...) __DOIT36(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT37(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT37(N, OP, FUNC, A, ...) __DOIT37(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT38(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT38(N, OP, FUNC, A, ...) __DOIT38(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT39(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT39(N, OP, FUNC, A, ...) __DOIT39(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT40(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT40(N, OP, FUNC, A, ...) __DOIT40(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT41(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT41(N, OP, FUNC, A, ...) __DOIT41(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT42(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT42(N, OP, FUNC, A, ...) __DOIT42(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT43(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT43(N, OP, FUNC, A, ...) __DOIT43(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT44(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT44(N, OP, FUNC, A, ...) __DOIT44(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT45(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT45(N, OP, FUNC, A, ...) __DOIT45(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT46(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT46(N, OP, FUNC, A, ...) __DOIT46(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT47(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT47(N, OP, FUNC, A, ...) __DOIT47(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT48(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT48(N, OP, FUNC, A, ...) __DOIT48(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT49(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT49(N, OP, FUNC, A, ...) __DOIT49(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT50(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT50(N, OP, FUNC, A, ...) __DOIT50(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT51(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT51(N, OP, FUNC, A, ...) __DOIT51(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT52(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT52(N, OP, FUNC, A, ...) __DOIT52(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT53(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT53(N, OP, FUNC, A, ...) __DOIT53(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT54(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT54(N, OP, FUNC, A, ...) __DOIT54(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT55(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT55(N, OP, FUNC, A, ...) __DOIT55(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT56(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT56(N, OP, FUNC, A, ...) __DOIT56(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT57(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT57(N, OP, FUNC, A, ...) __DOIT57(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT58(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT58(N, OP, FUNC, A, ...) __DOIT58(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT59(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT59(N, OP, FUNC, A, ...) __DOIT59(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT60(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT60(N, OP, FUNC, A, ...) __DOIT60(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT61(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT61(N, OP, FUNC, A, ...) __DOIT61(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT62(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
#define _DOIT62(N, OP, FUNC, A, ...) __DOIT62(_predecessor(N), OP, FUNC, A, __VA_ARGS__)
#define __DOIT63(N, OP, FUNC, A, ...) OP(FUNC(A), PASTE2(_DOIT, N)(N, OP, FUNC, __VA_ARGS__))
