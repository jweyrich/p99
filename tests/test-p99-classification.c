...
int main(int argc, char **argv) {
  ...
  P99_BUILTIN_TYPE(UINT32_C()) au32 = P99_INIT;
  P99_BUILTIN_TYPE(UINT64_C()) au64 = P99_INIT;
  P99_BUILTIN_TYPE(INT32_C()) ai32 = P99_INIT;
  P99_BUILTIN_TYPE(INT64_C()) ai64 = P99_INIT;
