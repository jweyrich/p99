...
DEFINE_THREAD(worker_thread) {
  ...
  P99_PROTECT:
     ...
     **/
    orwl_disconnect2(handle, nb_hand);
...
int main(int argc, char **argv) {
  ...
  pthread_t *const id = pthread_t_vnew(orwl_np/2);
  worker_thread *const arg = worker_thread_vnew(orwl_np/2);
